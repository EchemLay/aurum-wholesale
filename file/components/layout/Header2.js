    ...
    <div className="header-top">
      <div className="inner-container"> 
        ...
        <div className="top-right"> 
          ...
          <ul className="features-list light">
    ...
    <div className="header-lower"> 
      <div className="main-box">
        ...
        <div className="outer-box"> 
          ...
          <button className="ui-btn ui-btn cart-btn"> <i className="icon lnr lnr-icon-cart"></i> <span className="count">0</span> </button>
          
          <button className="ui-btn ui-btn search-btn" onClick={handleSearch}> <span className="icon lnr lnr-icon-search"></span> </button>
          <span className="divider"></span> 
          
          <Link href="tel:+1-848-667-2155" className="info-btn-two"> <i className="icon fal fa-comments"></i> <small>Call for inquiry</small> <strong>+36 55 540 069</strong> </Link> 
          
          <div className="btn-box"> <Link href="page-contact" className="theme-btn btn-style-one"><span className="btn-title">Request a quote <i className="fa fa-long-arrow-right"></i></span></Link> </div>
