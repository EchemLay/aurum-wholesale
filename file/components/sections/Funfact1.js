...
const Funfact1 = () => {
    return (
        <>
        <section className="funfacts-section pt-0">
            ...
            <div className="fact-counter">
                ...
                <div className="counter-block col-lg-4 col-md-4 col-sm-12 wow fadeInUp" data-wow-delay="300ms">
                    <div className="inner-box">
                ...
                <div className="counter-block col-lg-4 col-md-4 col-sm-12 wow fadeInUp" data-wow-delay="600ms">
                    <div className="inner-box">
