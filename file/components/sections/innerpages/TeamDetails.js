...
const TeamDetails = () => {
  ...
  {/* Team Details Start */}
  <section className="team-details team-contact-form">
            ...
            <div className="team-details__bottom-right">
              <div className="team-details__progress">
                <div className="team-details__progress-single">
                  ...
                  <div className="bar">
                    <div className="bar-inner count-bar" data-percent="90%" data-percent="90%" style={{width:"90%"}}>
                ...
                <div className="team-details__progress-single">
                  ...
                  <div className="bar">
                    <div className="bar-inner count-bar" data-percent="80%" data-percent="90%" style={{width:"80%"}}>
                ...
                <div className="team-details__progress-single">
                  ...
                  <div className="bar marb-0">
                    <div className="bar-inner count-bar" data-percent="75%" data-percent="90%" style={{width:"75%"}}>
  ...
  <section className="team-details-contact-form">
    <div className="container pb-100">
