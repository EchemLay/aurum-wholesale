...
const Faq = () => {
  ...
  {/*  FAQ Section  */}
  <section className="faqs-section innerpage pt-120">
    <div className="auto-container">
      <div className="row">
        ...
        <div className="faq-column col-lg-6">
          ...
          <div className="inner-column mb-50">
        ...
        <div className="faq-column col-lg-6">
          ...
          <div className="inner-column mb-50">
            <ul className="accordion-box ms-0 wow fadeInRight">
              ...
              {/* Block */}
              <li className="accordion block">
                <div className={isActive.key == 5 ? "acc-btn ps-0 active" : "acc-btn"} onClick={() => handleClick(5)}>
                  Which goods you want to transport?
                  <div className="icon fa fa-angle-right"></div>
                </div>
              ...
              {/* Block */}
              <li className="accordion block">
                <div className={isActive.key == 6 ? "acc-btn ps-0 active" : "acc-btn"} onClick={() => handleClick(6)}>
                  What is our transport necessity?
                  <div className="icon fa fa-angle-right"></div>
                </div>
