...
const Tab1 = () => {
  ...
  const handleOnClick = (index) => {
    ...
    return (
        <>
        <section className="contact-section-two pb-120">
                    ...
                    <div className="row">
                      ...
                      <div className="call-to-action col-lg-4">
                        <div className="inner-column">
                          ...
                          <a href="page-contact" className="theme-btn btn-style-one white-bg"><span className="btn-title"><i className="fa fa-long-arrow-right me-2"></i> Apply Now</span></a>
                        </div>
                      </div>
